       ...
       <div class="row">
			...
			<c:forEach var="gcv1" items="${gcvList}">
				<tr role="row" align="center" class="1" id="1_1" >
	                     ...
	                     <td>
	                      <a class="btn btn-primary" href="商品分类k-编辑.html">
				...
				<tr role="row" align="center" class="2" id="2_12" style="display:none">
					<td>${gcv2.id}</td>
	                 ...
	                 <td>
	                     ...
	                     <td>
	                      <a class="btn btn-primary" href="/index/Admin/Goods/addEditCategory/id/12"><i
								  class="fa fa-pencil"></i></a>
	                      <a class="btn btn-danger" href="javascript:del_fun('/index/Admin/Goods/delGoodsCategory/id/12');">
					...
					<c:forEach var="gcv3" items="${gcv2.children}">
						<tr role="row" align="center" class="3" id="3_100" style="display:none">
							...
							<td>
								index/Admin/System/login_task						<img width="20" height="20" src="${ctx}/Public/images/yes.png"
