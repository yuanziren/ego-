...
//                    break;
    ...
    function convert_url(s) {
        return s.replace(/http:\/\/www\.tudou\.com\/programs\/view\/([\w\-]+)\/?/i, "http://www.tudou.com/v/$1")
            ...
            .replace(/http:\/\/v\.youku\.com\/v_show\/id_([\w\-=]+)\.html/i, "http://player.youku.com/player/sid/$1")
    ...
    function createPreviewVideo(url) {
        ...
        if (!youkuPlay) {
            if (matches) {
                ...
                url = "http://player.youku.com/player/sid/" + youku[1] + "/v.swf"
